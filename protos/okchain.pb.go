...
const (
	...
	Message_DS_PoWSync                    Message_Type = 106
...
type PoWVoteMsgType int32

const (
	PoWVote_PREPREPARE PoWVoteMsgType = 0
	PoWVote_PREPARE    PoWVoteMsgType = 1
	PoWVote_COMMIT     PoWVoteMsgType = 2
)

var PoWVoteMsgType_name = map[int32]string{
	0: "PREPREPARE",
	1: "PREPARE",
	2: "COMMIT",
}
var PoWVoteMsgType_value = map[string]int32{
	"PREPREPARE": 0,
	"PREPARE":    1,
	"COMMIT":     2,
}

func (x PoWVoteMsgType) String() string {
	return proto.EnumName(PoWVoteMsgType_name, int32(x))
}
func (PoWVoteMsgType) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{32, 0} }
...
type PoWVote struct {
	Owner        *PeerEndpoint    `protobuf:"bytes,1,opt,name=Owner" json:"Owner,omitempty"`
	Peer         *PeerEndpoint    `protobuf:"bytes,2,opt,name=Peer" json:"Peer,omitempty"`
	Phase        PoWVoteMsgType   `protobuf:"varint,3,opt,name=Phase,enum=protos.PoWVoteMsgType" json:"Phase,omitempty"`
	Signature    []byte           `protobuf:"bytes,4,opt,name=Signature,proto3" json:"Signature,omitempty"`
	PoWContainer []*PoWSubmission `protobuf:"bytes,5,rep,name=PoWContainer" json:"PoWContainer,omitempty"`
}

func (m *PoWVote) Reset()                    { *m = PoWVote{} }
func (m *PoWVote) String() string            { return proto.CompactTextString(m) }
func (*PoWVote) ProtoMessage()               {}
func (*PoWVote) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{32} }

func (m *PoWVote) GetOwner() *PeerEndpoint {
	if m != nil {
		return m.Owner
	}
	return nil
...
func (m *PoWVote) GetPeer() *PeerEndpoint {
	if m != nil {
		return m.Peer
	}
	return nil
...
func (m *PoWVote) GetPhase() PoWVoteMsgType {
	if m != nil {
		return m.Phase
	}
	return PoWVote_PREPREPARE
}

func (m *PoWVote) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *PoWVote) GetPoWContainer() []*PoWSubmission {
	if m != nil {
		return m.PoWContainer
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*PoWVote)(nil), "protos.PoWVote")
	...
	proto.RegisterEnum("protos.PoWVoteMsgType", PoWVoteMsgType_name, PoWVoteMsgType_value)
}
...
var fileDescriptor3 = []byte{
	...
	,
}
